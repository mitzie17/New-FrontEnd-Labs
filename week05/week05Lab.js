...
let myGreeting = new Greeting('Mitzi', 'Los Angeles')
myGreeting.hello()
...
let yourBook = new Book("Harry Potter and the Sorcerer's Stone", 'J.K. Rowling')
...
class List {
  ...
  displayMovies() {
    ...
    for (let i = 0; i < this.movies.length; i++) {
      movieInfo += `${this.movies[i].title}, by ${this.movies[i].director}\n`
    }
    return movieInfo
  }
}
